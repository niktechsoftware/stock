                    ...
                    $ct =$this->cmodel->getCrecord($cid)->row();
                     ...
                     ?>
                       <tr>
                        ...
                        if($ct->status){?><input type="text" id ="activeid<?php echo $j;?>" name ="activateid"> <?php }else{ if($j<2){?>
                         ...
                         $.ajax({
                                    ...
                                    "url": "<?php echo site_url('pin/activateCustomer') ?>",
                                     ...
                                     beforeSend: function(data) {
                                        $("#activeid<?php echo $j;?>").html("<center><img src='<?php echo base_url(); ?>assets/img/loading.gif' /></center>")
                                     },

                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	<div class="panel-body">
                            		<div class="row">
                            			<div class="col-md-12">
                            				<form class="form-horizontal" action="<?php echo base_url()?>apanelForms/popup" method="post" enctype="multipart/form-data">
		                                        ...
		                                        <div class="form-group">
		                                            <label class="col-sm-3 control-label">Popup Image (Max. 1000kb)</label>
		                                            <div class="col-sm-9">
                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                        	...
                                        	<?php $res = $this->db->get("popup_image")->result();?>
                                         ...
                                         <tr> <td><?php echo $i; ?></td>
                                              ...
                                              <td><?php echo $row->desc;?>  <td><?php echo $row->date; ?></td>
                                                <td>
                                                  ...
                                                  <td>
                                                	<a href="http://thelifestylesapp.com/admin/apanel/popup1/<?php echo $row->sno;?>">
                                                	Edit
                                                	</a>
                                                </td>
                                            </tr>

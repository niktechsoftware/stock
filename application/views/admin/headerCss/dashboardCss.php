       ...
       <!-- <link href="<?php echo base_url()?>assets/admin/assets/plugins/fontawesome/css/font-awesome.css" rel="stylesheet" type="text/css"/>-->
        ...
        <link href="<?php echo base_url()?>assets/admin/assets/plugins/weather-icons-master/css/weather-icons.min.css" rel="stylesheet" type="text/css"/>	
        <link href="<?php echo base_url()?>assets/admin/assets/plugins/metrojs/MetroJs.min.css" rel="stylesheet" type="text/css"/>	
        <link href="<?php echo base_url()?>assets/admin/assets/plugins/toastr/toastr.min.css" rel="stylesheet" type="text/css"/>	

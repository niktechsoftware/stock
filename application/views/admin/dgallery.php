                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	<div class="panel-body">
                            		<div class="row">
                            			<div class="col-md-12">
                            				<form class="form-horizontal" action="<?php echo base_url()?>apanelForms/savedGallery" method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                        	...
                                        	<?php $res = $this->db->get("gallery_depart")->result();?>
                                         ...
                                         <tr> <td><?php echo $i; ?></td>
                                              ...
                                              <td><img width="50" height="50" src="<?php echo base_url();?>assets/images/client_gallery/<?php echo $this->session->userdata("client_code");?>/<?php echo $row->image; ?>" alt="" /></td>
                                                ...
                                                <td>
                                                	<a href="<?php echo base_url();?>apanelForms/deletedGallery/<?php echo $row->depart_id;?>">
                                                		Delete
                                                	</a>
                                                </td>
                                            </tr>
